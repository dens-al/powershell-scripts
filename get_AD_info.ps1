...
$folder = "D:\storage\1C_Files"
# здесь задаем уровень вложенности папок (-max №)
$folders = recursive $folder -max 4
...
$result | Export-Csv -path ('C:\Users\aabb02\Desktop\FolderReport({0})-{1:yyyyMMddHHmm}.csv' -f $foldername,(Get-Date)) -Encoding 'UTF8' -force -NoTypeInformation -UseCulture